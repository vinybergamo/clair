...
func CommandClone(oldAppName string, newAppName string, skipDeploy bool, ignoreExisting bool) error {
	...
	if err := common.PluginTrigger("post-app-clone-setup", []string{oldAppName, newAppName}...); err != nil {
		return err
	}
	...
	if err := common.PluginTrigger("git-has-code", []string{newAppName}...); err != nil {
		os.Setenv("SKIP_REBUILD", "true")
	}

	if err := common.PluginTrigger("post-app-clone", []string{oldAppName, newAppName}...); err != nil {
		return err
	}
...
func CommandRename(oldAppName string, newAppName string, skipDeploy bool) error {
	...
	if err := common.PluginTrigger("post-app-rename-setup", []string{oldAppName, newAppName}...); err != nil {
		return err
	}
	...
	if err := common.PluginTrigger("post-app-rename", []string{oldAppName, newAppName}...); err != nil {
		return err
	}
